...
class CInput(CWidget):
    ...
    template_name = 'forms.py/widgets/input.html'
    flag = False
...
class STextInput(CInput):
    input_type = "text"
    template_name = 'forms.py/widgets/text.html'
...
class SNumberInput(CInput):
    input_type = 'number'
    template_name = 'forms.py/widgets/number.html'
    def __init__(self, attrs: typing.Union[typing.Dict[str, str], None] = None):
        self.get_bind_attr(attrs)
        if not attrs:
            attrs = {}
...
class SEmailInput(CInput):
    input_type = 'email'
    template_name = 'forms.py/widgets/email.html'
    def __init__(self, attrs: typing.Union[typing.Dict[str, str], None] = None):
        self.get_bind_attr(attrs)
        if not attrs:
            attrs = {}
...
class SURLInput(CInput):
    input_type = 'url'
    template_name = 'forms.py/widgets/url.html'
    def __init__(self, attrs: typing.Union[typing.Dict[str, str], None] = None):
        self.get_bind_attr(attrs)
        if not attrs:
            attrs = {}
...
class SPasswordInput(CInput):
    input_type = 'password'
    template_name = 'forms.py/widgets/password.html'
...
class SCheckboxInput(CInput):
    ...
    """
    input_type = 'checkbox'
    template_name = 'forms.py/widgets/checkbox.html'
